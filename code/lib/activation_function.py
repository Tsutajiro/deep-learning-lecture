...
#  @param       x input (real numbers array)
#  @return      an array created by applying step function to x
def step(x):
    y = x > 0
...
#  @param       x input (real numbers array)
#  @return      an array created by applying sigmoid function to x
def sigmoid(x):
    return 1 / (1 + np.exp(-x))

## @brief       Apply ReLU function for all elements of x
#  @param       x input (real numbers array)
#  @return      an array created by applying ReLU function to x
def relu(x):
    return np.maximum(0, x)

## @brief       Apply identity function for all elements of x
#  @param       x input (real numbers array)
#  @return      an array created by applying identity function to x
def identity(x):
    return x

## @brief       Apply softmax function for all elements of x
#  @param       x input (real numbers array)
#  @return      an array created by applying softmax function to x
def softmax(x):
